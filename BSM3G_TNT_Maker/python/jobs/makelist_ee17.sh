...
for i in `xrdfs  root://ss-03.recas.ba.infn.it:8080 ls /store/user/vmariani/HavyCompositeMajoranaNeutrino_L4000_M500_eejj_CalcHep/eejj_17_L4_M500/SOMETHINGHERE/0000`;
do echo "root://ss-03.recas.ba.infn.it:8080/${i//\/cms/}" >> list_eejj_L4_M500.txt; done
sed -i -e "s/\"/\\\\\"/g" list_eejj_L4_M500.txt
sed -i -e "s/\//\\\\\//g" list_eejj_L4_M500.txt
...
for i in `xrdfs  root://ss-03.recas.ba.infn.it:8080 ls /store/user/vmariani/HavyCompositeMajoranaNeutrino_L5000_M3000_eejj_CalcHep/eejj_17_L5_M3000/SOMETHINGHERE/0000`;
...
do echo "root://ss-03.recas.ba.infn.it:8080/${i//\/cms/}" >> list_eejj_L7_M2000.txt; done
sed -i -e "s/\"/\\\\\"/g" list_eejj_L7_M2000.txt
sed -i -e "s/\//\\\\\//g" list_eejj_L7_M2000.txt
...
do echo "root://ss-03.recas.ba.infn.it:8080/${i//\/cms/}" >> list_eejj_L7_M5000.txt; done
sed -i -e "s/\"/\\\\\"/g" list_eejj_L7_M5000.txt
sed -i -e "s/\//\\\\\//g" list_eejj_L7_M5000.txt
...
do echo "root://ss-03.recas.ba.infn.it:8080/${i//\/cms/}" >> list_eejj_L9_M1000.txt; done
sed -i -e "s/\"/\\\\\"/g" list_eejj_L9_M1000.txt
sed -i -e "s/\//\\\\\//g" list_eejj_L9_M1000.txt
...
do echo "root://ss-03.recas.ba.infn.it:8080/${i//\/cms/}" >> list_eejj_L9_M4000.txt; done
sed -i -e "s/\"/\\\\\"/g" list_eejj_L9_M4000.txt
sed -i -e "s/\//\\\\\//g" list_eejj_L9_M4000.txt
...
do echo "root://ss-03.recas.ba.infn.it:8080/${i//\/cms/}" >> list_eejj_L11_M1000.txt; done
sed -i -e "s/\"/\\\\\"/g" list_eejj_L11_M1000.txt
sed -i -e "s/\//\\\\\//g" list_eejj_L11_M1000.txt
