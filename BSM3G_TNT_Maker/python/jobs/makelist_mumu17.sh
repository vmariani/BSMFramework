...
rm list_mumujj_L7_M5000.txt;
rm list_mumujj_L7_M6000.txt;
rm list_mumujj_L7_M7000.txt;
rm list_mumujj_L9_M500.txt;
rm list_mumujj_L9_M1000.txt;
...
do echo "root://ss-03.recas.ba.infn.it:8080/${i//\/cms/}" >> list_mumujj_L4_M500.txt; done
sed -i -e "s/\"/\\\\\"/g" list_mumujj_L4_M500.txt
sed -i -e "s/\//\\\\\//g" list_mumujj_L4_M500.txt
...
do echo "root://ss-03.recas.ba.infn.it:8080/${i//\/cms/}" >> list_mumujj_L4_M1000.txt; done
sed -i -e "s/\"/\\\\\"/g" list_mumujj_L4_M1000.txt
sed -i -e "s/\//\\\\\//g" list_mumujj_L4_M1000.txt
...
do echo "root://ss-03.recas.ba.infn.it:8080/${i//\/cms/}" >> list_mumujj_L4_M4000.txt; done
sed -i -e "s/\"/\\\\\"/g" list_mumujj_L4_M4000.txt
sed -i -e "s/\//\\\\\//g" list_mumujj_L4_M4000.txt
...
do echo "root://ss-03.recas.ba.infn.it:8080/${i//\/cms/}" >> list_mumujj_L5_M3000.txt; done
sed -i -e "s/\"/\\\\\"/g" list_mumujj_L5_M3000.txt
sed -i -e "s/\//\\\\\//g" list_mumujj_L5_M3000.txt
...
do echo "root://ss-03.recas.ba.infn.it:8080/${i//\/cms/}" >> list_mumujj_L6_M2000.txt; done
sed -i -e "s/\"/\\\\\"/g" list_mumujj_L6_M2000.txt
sed -i -e "s/\//\\\\\//g" list_mumujj_L6_M2000.txt
...
do echo "root://ss-03.recas.ba.infn.it:8080/${i//\/cms/}" >> list_mumujj_L7_M5000.txt; done
sed -i -e "s/\"/\\\\\"/g" list_mumujj_L7_M5000.txt
sed -i -e "s/\//\\\\\//g" list_mumujj_L7_M5000.txt

for i in `xrdfs  root://ss-03.recas.ba.infn.it:8080 ls /store/user/vmariani/HeavyCompositeMajoranaNeutrino_L7000_M6000_mumujj_CalcHep/mumujj_17_L7_M6000/190531_134938/0000`;
do echo "root://ss-03.recas.ba.infn.it:8080/${i//\/cms/}" >> list_mumujj_L7_M6000.txt; done
sed -i -e "s/\"/\\\\\"/g" list_mumujj_L7_M6000.txt
sed -i -e "s/\//\\\\\//g" list_mumujj_L7_M6000.txt

for i in `xrdfs  root://ss-03.recas.ba.infn.it:8080 ls /store/user/vmariani/HeavyCompositeMajoranaNeutrino_L7000_M7000_mumujj_CalcHep/mumujj_17_L7_M7000/190531_135050/0000`;
do echo "root://ss-03.recas.ba.infn.it:8080/${i//\/cms/}" >> list_mumujj_L7_M7000.txt; done
sed -i -e "s/\"/\\\\\"/g" list_mumujj_L7_M7000.txt
sed -i -e "s/\//\\\\\//g" list_mumujj_L7_M7000.txt
...
do echo "root://ss-03.recas.ba.infn.it:8080/${i//\/cms/}" >> list_mumujj_L9_M1000.txt; done
sed -i -e "s/\"/\\\\\"/g" list_mumujj_L9_M1000.txt
sed -i -e "s/\//\\\\\//g" list_mumujj_L9_M1000.txt

for i in `xrdfs  root://ss-03.recas.ba.infn.it:8080 ls /store/user/vmariani/HavyCompositeMajoranaNeutrino_L9000_M2000_mumujj_CalcHep/mumujj_17_L9_M2000/SOMETHINGHERE`;
...
for i in `xrdfs  root://ss-03.recas.ba.infn.it:8080 ls /store/user/vmariani/HavyCompositeMajoranaNeutrino_L1500_M500_mumujj_CalcHep/mumujj_17_L11_M500/190702_100758/0000`;
...
do echo "root://ss-03.recas.ba.infn.it:8080/${i//\/cms/}" >> list_mumujj_L13_M5000.txt; done
sed -i -e "s/\"/\\\\\"/g" list_mumujj_L13_M5000.txt
sed -i -e "s/\//\\\\\//g" list_mumujj_L13_M5000.txt
...
for i in `xrdfs  root://ss-03.recas.ba.infn.it:8080 ls /store/user/vmariani/HavyCompositeMajoranaNeutrino_L11000_M1000_mumujj_CalcHep/mumujj_17_L17_M1000/190702_101021/0000`;
do echo "root://ss-03.recas.ba.infn.it:8080/${i//\/cms/}" >> list_mumujj_L17_M1000.txt; done
sed -i -e "s/\"/\\\\\"/g" list_mumujj_L17_M1000.txt
sed -i -e "s/\//\\\\\//g" list_mumujj_L17_M1000.txt
...
do echo "root://ss-03.recas.ba.infn.it:8080/${i//\/cms/}" >> list_mumujj_L20_M500.txt; done
sed -i -e "s/\"/\\\\\"/g" list_mumujj_L20_M500.txt
sed -i -e "s/\//\\\\\//g" list_mumujj_L20_M500.txt
