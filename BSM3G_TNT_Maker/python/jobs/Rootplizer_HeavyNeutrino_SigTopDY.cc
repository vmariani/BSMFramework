...
double get_wgtlumi(string FileName){
 ...
 if(FileName.find("WW") != std::string::npos) wgt=75.8/7850000; 
 if(FileName.find("WZ") != std::string::npos) wgt=27.6/3885000; 
 if(FileName.find("ZZ") != std::string::npos) wgt=12.14/1979000; // uncert 0.01964
 if(FileName.find("WJetsHT100To200") != std::string::npos) wgt=1346.0/29521158; //uncert 4.069
 if(FileName.find("WJetsHT200To400") != std::string::npos) wgt=407.9/25468933; //uncert 1.207
 if(FileName.find("WJetsHT400To600") != std::string::npos) wgt=57.48/5932701; //uncert 0.172
 if(FileName.find("WJetsHT600To800") != std::string::npos) wgt=12.87/19771294; //uncert 0.03859
 if(FileName.find("WJetsHT800To1200") != std::string::npos) wgt=5.366/8402687; //uncert 0.1616
 if(FileName.find("WJetsHT1200To2500") != std::string::npos) wgt=1.074/7633949; // uncert 0.003261
 if(FileName.find("WJetsHT2500ToInf") != std::string::npos) wgt=0.008001/3273980; //uncert 2.486e-05
 if(FileName.find("WJets_") != std::string::npos) wgt=52940.0/71026861; //uncert 121.9
